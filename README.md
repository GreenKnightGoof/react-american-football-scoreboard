...
1. Hold each team's current score in a state value DONE
2. Render each team's current score that is in state to the DOM. DONE
3. Be able to click the different buttons to increment the appropriate team's score by the correct amount DONE
